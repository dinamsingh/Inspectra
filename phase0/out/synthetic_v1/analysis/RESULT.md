...
|---|---|---|
| C11_safe_measure_rate | PASS | measure rate on SAFE=0.94 (>=0.80) |
| C1_arithmetic | PASS | max|err|=0.00797 mm <= 0.010 |
| C2_accuracy | PASS | bias=+0.0009 (<=0.030), p95|err|=0.0072 (<=0.060) |
| C3_repeatability | PASS | median burst SD=0.0026 mm (<=0.030) |
| C4_coverage | PASS | coverage=1.000 on n=16 (>=0.90); k is NOMINAL, not validated |
| C5_estimator | PASS | model-fit MAE=0.0020 vs max-minus-min MAE=0.0029 |
| C6_linearisation | PASS | linear err=0.0004 vs gamma-glyph err=-0.0441; full gamma: PHYSICAL_SIZE_NOT_ESTABLISHED_GEOMETRY |
| C7_unsafe_detection | FAIL | abstained 8/9 |
...
| n_runs | 17.00000 |
| n_measured | 16.00000 |
| measure_rate | 0.94118 |
| bias_mm | 0.00088 |
| mae_mm | 0.00196 |
| p95_abs_error_mm | 0.00722 |
| max_abs_error_mm | 0.00966 |
| median_burst_sd_mm | 0.00265 |
| coverage | 1.00000 |
| coverage_n | 16.00000 |
| median_interval_width_mm | 0.05223 |
...
| N_MOTION_BLUR | PHYSICAL_SIZE_NOT_ESTABLISHED_IMAGE_QUALITY | IMAGE_QUALITY | snr |
...
| N_UNSTABLE_BOUNDARY | MEASURED | None | None |
...
|---|---|---|---|---|---|---|
| N_NONPLANAR_TILT-10 | MEASURED | -0.0456 | 0.0159 | 0.0 | 0.120 | 0.00023 |
| N_NONPLANAR_TILT-20 | MEASURED | -0.1847 | 0.0162 | 0.0 | 0.092 | 0.00020 |
| N_PLANE_OFFSET_UNDECLARED-1.5 | MEASURED | 0.0224 | 0.0153 | 1.0 | 0.101 | 0.00023 |
| N_PLANE_OFFSET_UNDECLARED-5.0 | MEASURED | 0.0802 | 0.0149 | 0.0 | 0.095 | 0.00023 |
...
| undistortion on | err=0.0011 reproj=0.079 px |
| undistortion off | err=n/a reproj=0.827 px |
| estimator: fitted extreme | MAE=0.0020 |
| estimator: max-minus-min | MAE=0.0029 |
